...
**Exigence EX-302** ► Pour chaque modèle listé, le système affiche : son nom, le nombre d'items (enregistrements) qu'il contient et le nombre de colonnes de sa table. ◄
...
**Exigence EX-313** ► Le listing des modèles peut être trié selon son nom, sa table, son nombre d'items ou son nombre de colonnes. ◄
