...
⚠️Si l'application hôte n'exécute pas la publication des assets après une mise à jour du plug-in, le front peut s'afficher avec une version obsolète des assets, sans que le plug-in ne détecte ni ne signale cette désynchronisation.
