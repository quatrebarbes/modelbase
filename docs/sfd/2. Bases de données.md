...
<limite>Point ouvert : l'ordre d'origine des connexions correspond à leur ordre d'énumération dans `config/database.php`, la SFD ne définit pas de critère de tri alternatif (alphabétique ou autre).</limite>
...
<exigence id="EX-214">Passé un délai de 10 secondes sans réponse pour une connexion donnée, celle-ci est considérée comme indisponible, indépendamment de l'état réel de la tentative de connexion sous-jacente.</exigence>

<limite>Si la tentative de connexion sous-jacente aboutit après ce délai de 10 secondes, la réponse tardive n'est pas prise en compte pour l'affichage en cours : la ligne reste au statut « indisponible » jusqu'au prochain chargement complet du listing.</limite>
